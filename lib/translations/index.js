export const translations = {
  en: {
    workspace: {
      ...
      organisation: {
        patientList: {
          noPatients: "No patients found. Please upload a CSV or add patients manually.",
          loading: "Loading...",
          uploadModal: {
      ...
      remoteMonitoring: {
        ...
        stepOne: {
          ...
          addPatientsGuide: "To add patients, go to Organisation Settings → Patients → Add Patient (it will take seconds)"
        },
        stepTwo: {
          ...
          preset: {
            selectPresetLabel: "Select Template:",
  ...
  es: {
    workspace: {
      ...
      organisation: {
        patientList: {
          noPatients: "No hay pacientes registrados. Por favor, suba un archivo CSV o agregue pacientes manualmente.",
          loading: "Cargando...",
          uploadModal: {
      ...
      remoteMonitoring: {
        ...
        stepTwo: {
          ...
          template: {
            ...
            addFirstObjective: "Agregar primer objetivo...",
            addNewObjective: "Agregar nuevo objetivo..."
          }
        },
        scheduler: {
